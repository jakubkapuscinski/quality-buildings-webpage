...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    services: [
      { name: 'Konstrukcje', href: '#services' },
      { name: 'Wykończenia', href: '#services' },
      { name: 'Projektowanie', href: '#services' },
      { name: 'Renowacje', href: '#services' }
    ],
    legal: [
    ...
    contact: [
      ...
      { name: 'kontakt@luxuryconstruction.pl', href: 'mailto:kontakt@luxuryconstruction.pl' },
      { name: 'ul. Luksusowa 123, Warszawa', href: '#' }
    ]
  };
  ...
  return (
    <footer className="text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-gray-950 pt-8 mt-8">
